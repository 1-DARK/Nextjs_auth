...
export default function SignupPage() {
    ...
    useEffect(() => {
        if (user.email.length > 0 && user.password.length > 0 && user.username.length > 0 && user.security_pin.length > 0) {
            setbuttondis(false);
        } else {
            setbuttondis(true);
        }
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 px-4">
            <div className="w-full max-w-md bg-gray-800 rounded-xl shadow-xl p-8 space-y-6 border border-gray-700">
                <h1 className="text-3xl font-bold text-center text-white">{loading ? "Processing" : "Create an Account"}</h1>
